...
const HomeHeader = () => {
  ...
  return (
    <header className="homepage__header">
        ...
        {/* Homepage Filters */}
        <div className="homepage-filters absolute bottom-[-1.5rem] bg-white shadow-slate-300 rounded-2xl shadow-md w-2/3 h-20 grid place-items-center">
          <div className="wrapper flex items-center justify-between w-full px-6">
            {/* Province */}
